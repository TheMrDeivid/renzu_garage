garagecoord = {
    {
        garage = "Pública", --LEGION
        Dist = 3, -- distance (DEPRECATED)
        Type = "car",
        Blip = {color = 38, sprite = 290, scale = 1.0},
